...
namespace DungeonLibrary
{
    public class Vampire : Monster
    {
        ...
        public Vampire(string name, int life, int maxLife, int hitChance,
        ...
        public override string ToString()
        {
            return string.Format("{0}\n{1}",
                base.ToString(),
                HourChangeBack.Hour < 6 || HourChangeBack.Hour > 18 ? "It looks strong and angry." : "In the daylight it looks weak and pathetic...");
        }
    }
}
